...
public class PyroModel extends EntityModel<PyroEntityRenderState> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData main = modelPartData.addChild("main", ModelPartBuilder.create(), ModelTransform.origin(0.0F, 21.0F, 0.0F));

		ModelPartData body = main.addChild("body", ModelPartBuilder.create().uv(0, 0).cuboid(-3.0F, -11.0F, -6.0F, 6.0F, 7.0F, 9.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, 0.0F, 0.0F));
		...
		ModelPartData neck = body.addChild("neck", ModelPartBuilder.create(), ModelTransform.origin(0.0F, -8.0F, -13.0F));
		...
		ModelPartData head = neck.addChild("head", ModelPartBuilder.create().uv(38, 8).cuboid(-1.0F, -2.5F, -1.5F, 2.0F, 3.0F, 1.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, -2.0F, -4.0F));

		ModelPartData upper = head.addChild("upper", ModelPartBuilder.create().uv(17, 30).cuboid(-0.9532F, 0.0185F, -4.3059F, 2.0F, 2.0F, 5.0F, new Dilation(0.0F)), ModelTransform.origin(-0.0468F, -2.5185F, -2.1941F));
		...
		ModelPartData lower = head.addChild("lower", ModelPartBuilder.create().uv(34, 30).cuboid(-1.0F, -0.5F, -4.5F, 2.0F, 1.0F, 5.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, 0.0F, -2.0F));

		ModelPartData wings = body.addChild("wings", ModelPartBuilder.create(), ModelTransform.origin(0.0F, 0.0F, 0.0F));

		ModelPartData left = wings.addChild("left", ModelPartBuilder.create(), ModelTransform.origin(0.0F, 0.0F, 0.0F));
		...
		ModelPartData right = wings.addChild("right", ModelPartBuilder.create(), ModelTransform.origin(-6.0F, 0.0F, 0.0F));
		...
		ModelPartData tail = body.addChild("tail", ModelPartBuilder.create().uv(0, 28).cuboid(-1.0F, -10.0F, 6.5F, 2.0F, 4.0F, 4.0F, new Dilation(0.0F))
				...
				.uv(15, 9).cuboid(0.0F, -9.0F, 18.0F, 0.0F, 3.0F, 7.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, 0.0F, -1.0F));
		...
		ModelPartData legs = main.addChild("legs", ModelPartBuilder.create(), ModelTransform.origin(0.0F, 0.0F, -1.0F));

		ModelPartData left2 = legs.addChild("left2", ModelPartBuilder.create().uv(30, 9).cuboid(-1.0F, -2.5F, -1.5F, 2.0F, 5.0F, 3.0F, new Dilation(0.0F)), ModelTransform.origin(4.0F, -5.5F, 1.5F));
		...
		ModelPartData feet = left2.addChild("feet", ModelPartBuilder.create().uv(0, 20).cuboid(3.0F, 0.0F, 3.5F, 2.0F, 2.0F, 1.0F, new Dilation(0.0F))
				...
				.uv(5, 5).cuboid(4.0F, 0.0F, 0.5F, 0.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.origin(-4.0F, 5.5F, -1.5F));
		...
		ModelPartData right2 = legs.addChild("right2", ModelPartBuilder.create().uv(29, 27).cuboid(-1.0F, -2.5F, -1.5F, 2.0F, 5.0F, 3.0F, new Dilation(0.0F)), ModelTransform.origin(-4.0F, -5.5F, 1.5F));
		...
		ModelPartData feet2 = right2.addChild("feet2", ModelPartBuilder.create().uv(0, 6).cuboid(3.0F, 0.0F, 3.5F, 2.0F, 2.0F, 1.0F, new Dilation(0.0F))
				...
				.uv(0, 4).cuboid(4.0F, 0.0F, 0.5F, 0.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.origin(-4.0F, 5.5F, -1.5F));
	...
	@Override
	public void setAngles(PyroEntityRenderState state) {
		super.setAngles(state);

		this.getMain().traverse().forEach(ModelPart::resetTransform);
		this.setHeadAngles(this.getHead().yaw, this.getHead().pitch);

		this.animateWalking(PyroAnimations.WALKING, state.limbSwingAnimationProgress, state.limbSwingAmplitude, 2.0f, 2.5f);
		this.animate(state.idleAnimationState, PyroAnimations.IDLE, state.age, 1f);
		this.animate(state.attackAnimationState, PyroAnimations.BITE, state.age, 1f);
	}
