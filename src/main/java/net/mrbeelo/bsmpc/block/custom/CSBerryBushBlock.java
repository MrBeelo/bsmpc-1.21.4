...
public class CSBerryBushBlock extends SweetBerryBushBlock {
    public CSBerryBushBlock(Settings settings) {
        super(settings);
    }

    @Override
    protected ItemStack getPickStack(WorldView world, BlockPos pos, BlockState state, boolean includeData) {
        return new ItemStack(ModItems.CS_BERRIES);
    }
    ...
    protected ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, BlockHitResult hit) {
        ...
        if (i > 1) {
            ...
            dropStack(world, pos, new ItemStack(ModItems.CS_BERRIES, j + (bl ? 1 : 0)));
