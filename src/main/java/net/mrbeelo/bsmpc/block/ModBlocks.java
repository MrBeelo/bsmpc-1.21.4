...
public class ModBlocks {
    ...
    public static final TintedParticleLeavesBlock CS_LEAVES = registerWithItem("cs_leaves", new TintedParticleLeavesBlock(0.01F, AbstractBlock.Settings.copy(Blocks.OAK_LEAVES).registryKey(regKeyBlock("cs_leaves")).nonOpaque()), new Item.Settings().registryKey(ModItems.regKeyItem("cs_leaves")).useBlockPrefixedTranslationKey());
